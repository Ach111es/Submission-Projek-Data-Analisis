...
@st.cache_data
def muat_data():
    return pd.read_csv('https://raw.githubusercontent.com/Ach111es/Submission-Projek-Data-Analisis/main/day.csv')
...
page = st.sidebar.radio('Pilih halaman', ['Suhu-Count','Musim-Count'])
